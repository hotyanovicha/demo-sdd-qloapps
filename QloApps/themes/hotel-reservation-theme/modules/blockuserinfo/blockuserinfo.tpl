...
<div id="header_user" {if $PS_CATALOG_MODE}class="header_user_catalog"{/if}>
	...
	<p id="header_user_info">
		...
		{if $logged}
			...
			<a href="{$link->getPageLink('index', true, NULL, "mylogout=1&token={$static_token}")|escape:'html':'UTF-8'}" title="{l s='Log me out' mod='blockuserinfo'}" class="logout" rel="nofollow" data-testid="logout-link">{l s='Sign out' mod='blockuserinfo'}</a>
		{else}
